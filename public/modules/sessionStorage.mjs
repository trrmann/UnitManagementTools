...
export class SessionStorage {
  ...
  get SessionStoragePruneTimer() {
    return this._sessionStoragePruneTimer;
  }
  get SessionStoragePruneIntervalMs() {
    return this._sessionStoragePruneIntervalMs;
  }

  // ===== Constructor =====
  constructor(
    sessionStoragePruneIntervalMs = SessionStorage.DefaultSessionStoragePruneIntervalMS,
  ) {
    this._keyRegistry = new Set();
    ...
    if (
      ...
      this.Get.constructor.name !== "AsyncFunction"
    ) {
    ...
    if (
      ...
      this.Set.constructor.name !== "AsyncFunction"
    ) {
      Object.defineProperty(this, "Set", {
        value: async (
          key,
          value,
          ttlMs = SessionStorage.DefaultSessionStorageValueExpireMS,
          isObject = false,
        ) => this._setSync(key, value, ttlMs, isObject),
        writable: false,
        enumerable: false,
        configurable: true,
      });
  ...
  // ===== Static Methods =====
  static get DefaultSessionStoragePruneIntervalMS() {
    return 120000;
  }
  static get DefaultSessionStorageValueExpireMS() {
    return 1800000;
  }
  ...
  static CopyFromJSON(dataJSON) {
    ...
    session._sessionStoragePruneIntervalMs =
      dataJSON._sessionStoragePruneIntervalMs;
  ...
  static CopyFromObject(destination, source) {
    ...
    destination._sessionStoragePruneIntervalMs =
      source._sessionStoragePruneIntervalMs;
  }
  ...
  StartSessionStoragePruneTimer(intervalMs = null) {
    TimerUtils.start(
      this,
      "_sessionStoragePruneTimer",
      "_sessionStoragePruneIntervalMs",
      () => this.SessionStoragePrune(),
      intervalMs || SessionStorage.DefaultSessionStoragePruneIntervalMS,
    );
  }
