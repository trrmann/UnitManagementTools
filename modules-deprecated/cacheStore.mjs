...
export class CacheStore {
  ...
  static FromCacheStore(instance) {
    const cache = new CacheStore(
      instance._cachePruneIntervalMs || CacheStore.DefaultCachePruneIntervalMS,
    );
  ...
  // ===== Static Methods =====
  static get DefaultCachePruneIntervalMS() {
    return 60000;
  }
  static get DefaultCacheValueExpireMS() {
    return 900000;
  }
  ...
  static async Factory(
    cachePruneIntervalMs = CacheStore.DefaultCachePruneIntervalMS,
  ) {
  ...
  StartCachePruneTimer(intervalMs = null) {
    TimerUtils.start(
      this,
      "_cachePruneTimer",
      "_cachePruneIntervalMs",
      () => this.CachePrune(),
      intervalMs || CacheStore.DefaultCachePruneIntervalMS,
    );
  }
  ...
  ResumeCachePruneTimer() {
    TimerUtils.resume(this, "_cachePruneTimer", "_cachePruneIntervalMs", () =>
      this.CachePrune(),
    );
  }
  StopCachePruneTimer() {
